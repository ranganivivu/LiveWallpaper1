 ...
 */
public class FiveFragment extends Fragment implements RecyclerAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.fimRecyclerView);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        mProgressBar = view.findViewById(R.id.fimyDataLoaderProgressBar);
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("favorat");
